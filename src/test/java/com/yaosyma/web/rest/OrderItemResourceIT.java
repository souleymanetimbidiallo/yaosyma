...
import static com.yaosyma.domain.OrderItemAsserts.*;
...
import com.yaosyma.service.OrderItemService;
...
class OrderItemResourceIT {
    ...
    public static OrderItem createEntity(EntityManager em) {
        OrderItem orderItem = new OrderItem().quantity(DEFAULT_QUANTITY).unitPrice(DEFAULT_UNIT_PRICE).totalPrice(DEFAULT_TOTAL_PRICE);
        return orderItem;
    }
    ...
    public static OrderItem createUpdatedEntity(EntityManager em) {
        OrderItem orderItem = new OrderItem().quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).totalPrice(UPDATED_TOTAL_PRICE);
        return orderItem;
    }
    ...
    void putExistingOrderItem() throws Exception {
        ...
        updatedOrderItem.quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).totalPrice(UPDATED_TOTAL_PRICE);
    ...
    void fullUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).totalPrice(UPDATED_TOTAL_PRICE);
