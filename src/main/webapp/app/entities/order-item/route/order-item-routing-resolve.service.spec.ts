...
describe('OrderItem routing resolve service', () => {
  ...
  let resultOrderItem: IOrderItem | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IOrderItem returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        orderItemResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultOrderItem).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IOrderItem>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
