...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 213 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 10985 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 5697 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 24041 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 13757 };
      post.blog = blog;
      const tag: ITag = { id: 5342 };
      post.tags = [tag];
