...
import { EntityArrayResponseType, DriverService } from '../service/driver.service';
...
export class DriverComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDriver): number => this.driverService.getDriverIdentifier(item);
